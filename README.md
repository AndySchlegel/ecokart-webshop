...
> **Active development happens on the [`develop`](https://github.com/AndySchlegel/ecokart-webshop/tree/develop) branch.** This branch reflects the latest code, features, and documentation.
